...
public:
    ...
    void setupUi(QMainWindow *MainForm)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/images/icons/open_file.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionOpen->setIcon(icon);
        actionExit = new QAction(MainForm);
        actionExit->setObjectName("actionExit");
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/images/icons/exit.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/images/icons/pointpol.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionPoint_Polygon->setIcon(icon2);
        actionClear_data = new QAction(MainForm);
        actionClear_data->setObjectName("actionClear_data");
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/images/icons/clear.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("images/icons/winding.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/images/icons/ray.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
